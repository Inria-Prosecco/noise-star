...
[@@ noextract_to "krml"] noextract unfold let region_to_loc = B.loc_all_regions_from false
[@@ noextract_to "krml"] noextract unfold let disjoint_regions r1 r2 = B.loc_disjoint (region_to_loc r1) (region_to_loc r2)
[@@ noextract_to "krml"] noextract unfold let region_includes r1 = B.loc_includes (region_to_loc r1)
[@@ noextract_to "krml"] noextract unfold let region_includes_region r1 r2 = B.loc_includes (region_to_loc r1) (region_to_loc r2)
