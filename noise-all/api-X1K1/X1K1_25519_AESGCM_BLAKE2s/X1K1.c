          ...
          else
          {
            ...
            if (st.tag == Noise_X1K1_IMS_Handshake)
            {
              ...
              if ((uint32_t)31U <= (uint32_t)32U)
                ...
                Noise_X1K1_hash(st_h, (uint32_t)31U, pname);
          ...
          pname[31U] =
            {
              ...
              (uint8_t)53U, (uint8_t)53U, (uint8_t)49U, (uint8_t)57U, (uint8_t)95U, (uint8_t)65U,
              (uint8_t)69U, (uint8_t)83U, (uint8_t)71U, (uint8_t)67U, (uint8_t)77U, (uint8_t)95U,
    ...
    if (dst_st.tag == Noise_X1K1_IMS_Handshake)
    {
      ...
      else
      {
        ...
        if (st_step == (uint32_t)0U)
        {
          ...
          if (!(payload_len <= (uint32_t)2147483648U && outlen == (uint32_t)32U + payload_len))
            res =
              (
                (result_resp_state_t){
                  .tag = Fail0,
  ...
  else if (dst.tag == Noise_X1K1_DS_Responder)
  {
    ...
    if (dst_st.tag == Noise_X1K1_IMS_Handshake)
    {
      ...
      else
      {
        ...
        {
          result_init_state_t res;
          if (!(payload_len <= (uint32_t)2147483648U && outlen == (uint32_t)16U + payload_len))
            res =
              (
                (result_init_state_t){
                  .tag = Fail0,
  ...
  if (dst.tag == Noise_X1K1_DS_Initiator)
  {
    ...
    if (dst_st.tag == Noise_X1K1_IMS_Handshake)
    {
      ...
      else
      {
        ...
        {
          Noise_X1K1_error_code r0;
          if (!(payload_outlen <= (uint32_t)2147483648U && inlen == (uint32_t)16U + payload_outlen))
            r0 = Noise_X1K1_CInput_size;
          else
          {
  ...
  else if (dst.tag == Noise_X1K1_DS_Responder)
  {
    ...
    if (dst_st.tag == Noise_X1K1_IMS_Handshake)
    {
      ...
      else
      {
        ...
        {
          Noise_X1K1_error_code r0;
          if (!(payload_outlen <= (uint32_t)2147483648U && inlen == (uint32_t)32U + payload_outlen))
            r0 = Noise_X1K1_CInput_size;
          else
          {
            uint8_t *msg_input = input;
