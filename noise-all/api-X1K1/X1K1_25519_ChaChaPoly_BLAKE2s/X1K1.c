      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            uint8_t *pat_out = out;
            uint8_t *payload_out = out + pat_outlen;
            Noise_encrypt_and_hash((uint32_t)32U, st_spub, pat_out, st_cipher, st_h, (uint64_t)1U);
      ...
      else
      {
        ...
        if (st_step == (uint32_t)1U)
        {
          ...
          else
          {
            ...
            {
              Noise_error_code r = Noise_mix_dh(st_spriv, st_re, st_cipher, st_ck, st_h);
      ...
      else
      {
        ...
        if (st_step == (uint32_t)1U)
        {
          ...
          else
          {
            ...
            if (r11 == Noise_CSuccess)
            {
              Noise_error_code r2 = Noise_mix_dh(st_epriv, st_rs, st_cipher, st_ck, st_h);
              r20 = r2;
            }
            else
              r20 = r11;
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            Noise_error_code
            r = Noise_decrypt_and_hash((uint32_t)32U, st_rs, msg1, st_cipher, st_h, (uint64_t)1U);
