    ...
    case Noise_NXpsk2_CSuccess:
      {
        ...
        else
        {
          ...
          pname[32U] =
            {
              ...
              (uint8_t)95U, (uint8_t)65U, (uint8_t)69U, (uint8_t)83U, (uint8_t)71U, (uint8_t)67U,
              (uint8_t)77U, (uint8_t)95U, (uint8_t)83U, (uint8_t)72U, (uint8_t)65U, (uint8_t)50U,
              (uint8_t)53U, (uint8_t)54U
            };
          if (st.tag == Noise_NXpsk2_IMS_Handshake)
          {
            ...
            if ((uint32_t)32U <= (uint32_t)32U)
              memcpy(st_h, pname, (uint32_t)32U * sizeof (uint8_t));
            else
              Noise_NXpsk2_hash(st_h, (uint32_t)32U, pname);
            ...
            pname[32U] =
              {
                ...
                (uint8_t)49U, (uint8_t)57U, (uint8_t)95U, (uint8_t)65U, (uint8_t)69U, (uint8_t)83U,
                (uint8_t)71U, (uint8_t)67U, (uint8_t)77U, (uint8_t)95U, (uint8_t)83U, (uint8_t)72U,
                (uint8_t)65U, (uint8_t)50U, (uint8_t)53U, (uint8_t)54U
              };
            if (st.tag == Noise_NXpsk2_IMS_Handshake)
            {
...
)
{
  ...
  if (dst.tag == Noise_NXpsk2_DS_Initiator)
  {
    ...
    if (st.tag == Noise_NXpsk2_IMS_Handshake)
    {
      ...
      option__uint32_t scrut;
      if ((uint32_t)0U == step)
        if (payload_len <= (uint32_t)2147483648U)
