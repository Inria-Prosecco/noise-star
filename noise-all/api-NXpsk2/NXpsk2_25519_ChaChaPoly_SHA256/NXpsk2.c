        ...
        else
        {
          ...
          if (st.tag == Noise_IMS_Handshake)
          {
            ...
            if ((uint32_t)36U <= (uint32_t)32U)
              ...
              Noise_hash(st_h, (uint32_t)36U, pname);
    ...
    if (dst_st.tag == Noise_IMS_Handshake)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          Noise_kdf(st_ck, (uint32_t)32U, st_epub, st_ck, st_cipher, NULL);
      ...
      else
      {
        ...
        else
        {
          ...
          if (r11 == Noise_CSuccess)
          {
            ...
            Noise_encrypt_and_hash((uint32_t)32U, st_spub, tk_out2, st_cipher, st_h, (uint64_t)0U);
            Noise_error_code r13 = Noise_mix_dh(st_spriv, st_re, st_cipher, st_ck, st_h);
            Noise_error_code r2;
            if (r13 == Noise_CSuccess)
            {
    ...
    if (dst_st.tag == Noise_IMS_Handshake)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          Noise_kdf(st_ck, (uint32_t)32U, tk_input, st_ck, st_cipher, NULL);
    ...
    if (dst_st.tag == Noise_IMS_Handshake)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          Noise_kdf(st_ck, (uint32_t)32U, msg_input, st_ck, st_cipher, NULL);
