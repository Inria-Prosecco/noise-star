    ...
    case Noise_NXpsk2_CSuccess:
      {
        ...
        else
        {
          ...
          pname[33U] =
            {
              ...
              (uint8_t)69U, (uint8_t)50U, (uint8_t)115U
            };
          if (st.tag == Noise_NXpsk2_IMS_Handshake)
          {
            ...
            if ((uint32_t)33U <= (uint32_t)32U)
              memcpy(st_h, pname, (uint32_t)33U * sizeof (uint8_t));
            else
              Noise_NXpsk2_hash(st_h, (uint32_t)33U, pname);
            ...
            pname[33U] =
              {
                ...
                (uint8_t)65U, (uint8_t)75U, (uint8_t)69U, (uint8_t)50U, (uint8_t)115U
              };
            if (st.tag == Noise_NXpsk2_IMS_Handshake)
            {
