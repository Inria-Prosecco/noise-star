          ...
          if (res0 == Noise_CSuccess)
            ...
            switch (res0)
            {
              case Noise_CDH_error:
                {
                  res =
                    ((result_resp_state_t){ .tag = Fail0, .val = { .case_Fail = Noise_CDH_error } });
                  break;
                }
              default:
                {
    ...
    if (dst_st.tag == Noise_IMS_Handshake)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          Noise_error_code r0 = Noise_mix_dh(st_epriv, st_re, st_cipher, st_ck, st_h);
          Noise_error_code r2 = r0;
    ...
    if (dst_st.tag == Noise_IMS_Handshake)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          Noise_error_code r20 = Noise_mix_dh(st_epriv, st_re, st_cipher, st_ck, st_h);
          Noise_error_code r1 = r20;
          Noise_error_code r;
          if (!(r1 == Noise_CSuccess))
            r = r1;
    ...
    if (dst_st.tag == Noise_IMS_Handshake)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          Noise_mix_hash(st_h, (uint32_t)32U, tk_input1);
          Noise_kdf(st_ck, (uint32_t)32U, tk_input1, st_ck, st_cipher, NULL);
          memcpy(st_re, tk_input1, (uint32_t)32U * sizeof (uint8_t));
          Noise_error_code r20 = Noise_mix_dh(st_spriv, st_re, st_cipher, st_ck, st_h);
          Noise_error_code r21 = r20;
          Noise_error_code r1 = r21;
          Noise_error_code r;
          if (!(r1 == Noise_CSuccess))
            r = r1;
          else
