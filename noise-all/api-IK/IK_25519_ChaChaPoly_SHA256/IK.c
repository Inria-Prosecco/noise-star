      ...
      else
      {
        ...
        else
        {
          ...
          if (r11 == Noise_CSuccess)
          {
            ...
            Noise_error_code r = Noise_mix_dh(st_spriv, st_rs, st_cipher, st_ck, st_h);
    ...
    if (dst_st.tag == Noise_IMS_Handshake)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if (r11 == Noise_CSuccess)
          {
            Noise_error_code r = Noise_mix_dh(st_epriv, st_rs, st_cipher, st_ck, st_h);
            Noise_error_code r20 = r;
            r2 = r20;
          }
          else
    ...
    if (dst_st.tag == Noise_IMS_Handshake)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if (r11 == Noise_CSuccess)
          {
            Noise_error_code r2 = Noise_mix_dh(st_spriv, st_re, st_cipher, st_ck, st_h);
            r20 = r2;
          }
          else
            r20 = r11;
    ...
    if (dst_st.tag == Noise_IMS_Handshake)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          Noise_error_code r110 = Noise_mix_dh(st_spriv, st_re, st_cipher, st_ck, st_h);
          Noise_error_code r20;
          ...
          if (r10 == Noise_CSuccess)
          {
            ...
            if (r1)
            {
              ...
              Noise_error_code r11 = Noise_mix_dh(st_spriv, st_rs, st_cipher, st_ck, st_h);
              Noise_error_code r;
              if (!(r11 == Noise_CSuccess))
                r = r11;
              else
