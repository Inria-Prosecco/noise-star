        ...
        else
        {
          ...
          pname[36U] =
            {
              ...
              (uint8_t)75U, (uint8_t)88U, (uint8_t)112U, (uint8_t)115U, (uint8_t)107U, (uint8_t)50U,
          ...
          if (st.tag == Noise_KXpsk2_IMS_Handshake)
          {
            ...
            if ((uint32_t)36U <= (uint32_t)32U)
              ...
              Noise_KXpsk2_hash(st_h, (uint32_t)36U, pname);
            ...
            pname[36U] =
              {
                ...
                (uint8_t)95U, (uint8_t)75U, (uint8_t)88U, (uint8_t)112U, (uint8_t)115U,
    ...
    if (dst_st.tag == Noise_KXpsk2_IMS_Handshake)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          Noise_KXpsk2_kdf(st_ck, (uint32_t)32U, st_epub, st_ck, st_cipher, NULL);
        ...
        else if (res2.tag == Res)
        {
          ...
          if (st_step == (uint32_t)1U)
          {
            ...
            if (st1.tag == Noise_KXpsk2_IMS_Handshake)
            {
              ...
              Noise_KXpsk2_kdf(st_ck1, (uint32_t)0U, NULL, k1, k2, NULL);
              KRML_HOST_FREE(st_k);
    ...
    if (dst_st.tag == Noise_KXpsk2_IMS_Handshake)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          Noise_KXpsk2_kdf(st_ck, (uint32_t)32U, tk_input, st_ck, st_cipher, NULL);
    ...
    if (dst_st.tag == Noise_KXpsk2_IMS_Handshake)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          Noise_KXpsk2_kdf(st_ck, (uint32_t)32U, msg_input, st_ck, st_cipher, NULL);
