    ...
    if (dst_st.tag == Noise_IKpsk2_IMS_Handshake)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          Noise_IKpsk2_kdf(st_ck, (uint32_t)32U, st_epub, st_ck, temp_k, NULL);
        ...
        else if (res2.tag == Res)
        {
          ...
          if (st_step == (uint32_t)1U)
          {
            ...
            if (st1.tag == Noise_IKpsk2_IMS_Handshake)
            {
              ...
              Noise_IKpsk2_kdf(st_ck1, (uint32_t)0U, NULL, temp_k1, temp_k2, NULL);
    ...
    if (dst_st.tag == Noise_IKpsk2_IMS_Handshake)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          uint8_t temp_k[64U] = { 0U };
          Noise_IKpsk2_kdf(st_ck, (uint32_t)32U, tk_input, st_ck, temp_k, NULL);
          memcpy(st_cipher, temp_k, (uint32_t)32U * sizeof (uint8_t));
          Lib_Memzero0_memzero(temp_k, (uint32_t)64U * sizeof (temp_k[0U]));
