    ...
    if (dst_st.tag == Noise_IMS_Handshake)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          Noise_encrypt_and_hash((uint32_t)32U, st_spub, tk_out1, st_cipher, st_h, (uint64_t)0U);
    ...
    if (dst_st.tag == Noise_IMS_Handshake)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          Noise_error_code
          r0 = Noise_decrypt_and_hash((uint32_t)32U, st_rs, input_, st_cipher, st_h, (uint64_t)0U);
