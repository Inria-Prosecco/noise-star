...
#define Noise_KK_Success 0
#define Noise_KK_Error 1
#define Noise_KK_Stuck 2

typedef uint8_t Noise_KK_rcode_tags;

typedef struct Noise_KK_rcode_s
{
  Noise_KK_rcode_tags tag;
  union {
    Noise_KK_error_code case_Error;
    Noise_KK_error_code case_Stuck;
  }
  val;
}
Noise_KK_rcode;
...
typedef uint8_t Noise_KK_conf_level_t;

typedef uint8_t Noise_KK_auth_level_t;

#define NOISE_KK_AUTH_ZERO ((uint8_t)0U)

#define NOISE_KK_AUTH_KNOWN_SENDER ((uint8_t)1U)

#define NOISE_KK_AUTH_KNOWN_SENDER_NO_KCI ((uint8_t)2U)

#define NOISE_KK_MAX_AUTH_LEVEL ((uint8_t)2U)

#define NOISE_KK_CONF_ZERO ((uint8_t)0U)

#define NOISE_KK_CONF_KNOWN_RECEIVER ((uint8_t)2U)

#define NOISE_KK_CONF_KNOWN_RECEIVER_NON_REPLAYABLE ((uint8_t)3U)

#define NOISE_KK_CONF_STRONG_FORWARD_SECRECY ((uint8_t)5U)

#define NOISE_KK_MAX_CONF_LEVEL ((uint8_t)5U)

#define Noise_KK_Auth_level 0
#define Noise_KK_Conf_level 1
#define Noise_KK_No_level 2

typedef uint8_t Noise_KK_ac_level_t_tags;

typedef struct Noise_KK_ac_level_t_s
{
  Noise_KK_ac_level_t_tags tag;
  union {
...
typedef struct Noise_KK_encap_message_t_s Noise_KK_encap_message_t;

typedef Noise_KK_encap_message_t *Noise_KK_encap_message_p_or_null;
...
typedef Noise_KK_encap_message_t *Noise_KK_encap_message_p;
...
extern Prims_int Noise_KK_num_pattern_messages;
...
An instanciation of the NoiseAPI for the KK pattern.
...
typedef struct Noise_KK_cell_s
{
  Noise_KK_cell *next;
  Noise_KK_peer_t *data;
}
Noise_KK_cell;
