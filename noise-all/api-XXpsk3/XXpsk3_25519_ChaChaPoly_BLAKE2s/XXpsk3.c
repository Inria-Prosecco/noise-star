      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            Noise_encrypt_and_hash((uint32_t)32U, st_spub, tk_out, st_cipher, st_h, (uint64_t)1U);
            Noise_error_code r11 = Noise_mix_dh(st_spriv, st_re, st_cipher, st_ck, st_h);
            Noise_error_code r2;
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            Noise_error_code
            r1 = Noise_decrypt_and_hash((uint32_t)32U, st_rs, msg1, st_cipher, st_h, (uint64_t)1U);
            Noise_error_code r3 = r1;
            Noise_error_code r10 = r3;
            if (r10 == Noise_CSuccess)
            {
              Noise_cell **peers1 = dv0.dv_peers;
              Noise_cell *llt = *peers1;
