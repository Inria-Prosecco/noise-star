    ...
    case Noise_X1X_CSuccess:
      {
        ...
        else
        {
          ...
          pname[29U] =
            {
              ...
              (uint8_t)83U, (uint8_t)71U, (uint8_t)67U, (uint8_t)77U, (uint8_t)95U, (uint8_t)83U,
          ...
          if (st.tag == Noise_X1X_IMS_Handshake)
          {
            ...
            if ((uint32_t)29U <= (uint32_t)32U)
              memcpy(st_h, pname, (uint32_t)29U * sizeof (uint8_t));
            else
              Noise_X1X_hash(st_h, (uint32_t)29U, pname);
