      ...
      else
      {
        ...
        else
        {
          ...
          if (r11 == Noise_CSuccess)
          {
            ...
            Noise_error_code r13 = Noise_mix_dh(st_spriv, st_rs, st_cipher, st_ck, st_h);
            Noise_error_code r2;
        ...
        else
        {
          ...
          if (r10 == Noise_CSuccess)
          {
            ...
            if (r1)
            {
              ...
              Noise_error_code r110 = Noise_mix_dh(st_spriv, st_rs, st_cipher, st_ck, st_h);
...
/*
  DO NOT use this: for tests and benchmarks only
*/
Noise_session_t *Noise__session_create_responder_with_ephemeral(Noise_device_t *dvp)
{
  Noise_device_t dv = dvp[0U];
  result_session_t res;
  if (dv.dv_states_counter == (uint32_t)4294967295U)
