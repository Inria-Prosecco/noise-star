          ...
          else
          {
            ...
            if (st.tag == Noise_Xpsk1_IMS_Handshake)
            {
              ...
              if ((uint32_t)36U <= (uint32_t)32U)
                ...
                Noise_Xpsk1_hash(st_h, (uint32_t)36U, pname);
    ...
    pname[36U] =
      {
        ...
        (uint8_t)80U, (uint8_t)111U, (uint8_t)108U, (uint8_t)121U, (uint8_t)95U, (uint8_t)66U,
        (uint8_t)76U, (uint8_t)65U, (uint8_t)75U, (uint8_t)69U, (uint8_t)50U, (uint8_t)115U
      };
    if (st.tag == Noise_Xpsk1_IMS_Handshake)
    {
