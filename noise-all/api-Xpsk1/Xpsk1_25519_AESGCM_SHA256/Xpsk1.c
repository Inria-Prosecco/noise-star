        ...
        else
        {
          ...
          else
          {
            ...
            pname[31U] =
              {
                ...
                (uint8_t)67U, (uint8_t)77U, (uint8_t)95U, (uint8_t)83U, (uint8_t)72U, (uint8_t)65U,
            ...
            if (st.tag == Noise_Xpsk1_IMS_Handshake)
            {
              ...
              if ((uint32_t)31U <= (uint32_t)32U)
                memcpy(st_h, pname, (uint32_t)31U * sizeof (uint8_t));
              else
                Noise_Xpsk1_hash(st_h, (uint32_t)31U, pname);
    ...
    pname[31U] =
      {
        ...
        (uint8_t)95U, (uint8_t)83U, (uint8_t)72U, (uint8_t)65U, (uint8_t)50U, (uint8_t)53U,
        (uint8_t)54U
      };
    if (st.tag == Noise_Xpsk1_IMS_Handshake)
    {
