          ...
          else
          {
            ...
            if (st.tag == Noise_XNpsk3_IMS_Handshake)
            {
              ...
              if ((uint32_t)32U <= (uint32_t)32U)
                ...
                Noise_XNpsk3_hash(st_h, (uint32_t)32U, pname);
  ...
  if (dst.tag == Noise_XNpsk3_DS_Initiator)
  {
    ...
    if (dst_st.tag == Noise_XNpsk3_IMS_Handshake)
    {
      ...
      else
      {
        ...
        {
          result_init_state_t res;
          if (!(payload_len <= (uint32_t)2147483648U && outlen == (uint32_t)64U + payload_len))
            res =
              (
                (result_init_state_t){
                  .tag = Fail,
    ...
    if (dst_st.tag == Noise_XNpsk3_IMS_Handshake)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if (!(payload_outlen <= (uint32_t)2147483648U && inlen == (uint32_t)64U + payload_outlen))
